						...
						<center> <h5 style="font-family: Noto Sans;">Login to </h5><h4 style="font-family: Noto Sans;">Online Quiz System</h4></center><br>
							<form method="post" action="login.php" enctype="multipart/form-data">
								...
								<div class="form-group text-right">
									...
									<a href="index.php" class="btn btn-primary btn-block">Close</a></div>
								</div>
								<div class="form-group text-center">
									<span class="text-muted">Don't have an account?</span> <a href="register.php"><b> Register</b></a> Here..
								</div>
							</form>
						</div>
					</div>
